...
function switchTab(tabId) {
  ...
  $('#dashboard-grid').style.display = tabId === 'dashboard' ? '' : 'none';
  $('#panel-predictive').style.display = tabId === 'predictive' ? '' : 'none';
  $('#panel-prescriptive').style.display = tabId === 'prescriptive' ? '' : 'none';
}
